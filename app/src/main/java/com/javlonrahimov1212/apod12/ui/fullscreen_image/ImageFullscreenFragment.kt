package com.javlonrahimov1212.apod12.ui.fullscreen_image
...
class ImageFullscreenFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val apodUrl = args.apodUrl

        if (apodUrl.endsWith(".jpg"))
            Glide.with(image_fullscreen_fragment.context)
                .load(apodUrl)
                .into(image_fullscreen_fragment)
        else {
            Glide.with(image_fullscreen_fragment.context)
                .load(getThumbnailUrl(apodUrl))
                .into(image_fullscreen_fragment)
        }
